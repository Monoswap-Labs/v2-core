...
import "./interfaces/IMonoswapV2Pair.sol";
import "./MonoswapV2ERC20.sol";
...
contract MonoswapV2Pair is IMonoswapV2Pair, MonoswapV2ERC20 {
    ...
    modifier lock() {
        require(unlocked == 1, "MONOSWAPV2: LOCKED");
        unlocked = 0;
        _;
        unlocked = 1;
    }
    ...
    function mint(address to) external lock returns (uint liquidity) {
        ...
        require(liquidity > 0, "MONOSWAPV2: INSUFFICIENT_LIQUIDITY_MINTED");
        _mint(to, liquidity);
    ...
    function burn(
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "MONOSWAPV2: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "MONOSWAPV2: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "MONOSWAPV2: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint balance1;
        {
            ...
            require(to != _token0 && to != _token1, "MONOSWAPV2: INVALID_TO");
            if (amount0Out > 0) _safeTransfer(_token0, to, amount0Out); // optimistically transfer tokens
            if (amount1Out > 0) _safeTransfer(_token1, to, amount1Out); // optimistically transfer tokens
            if (data.length > 0)
                IMonoswapV2Callee(to).monoswapV2Call(
                    msg.sender,
                    amount0Out,
                    amount1Out,
                    data
        ...
        require(
            ...
            "MONOSWAPV2: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
